...
- Los prestamos al sector privado reales se agregan como promedio mensual de saldos diarios y se desestacionalizan con X-13ARIMA-SEATS (ajuste final X-11, tabla d11).
...
- Recaudacion total, ingresos fiscales, gasto primario y subsidios a la energia se expresan en millones de pesos a precios de 2014. Cada grafico muestra la serie mensual original deflactada en azul claro y su tendencia-ciclo (`d12`) destacada en azul oscuro. La tendencia se estima con X-13ARIMA-SEATS sobre toda la historia real disponible, con evaluacion de efectos calendario por AIC y deteccion automatica de valores atipicos; la serie desestacionalizada (`d11`) no se grafica. Ingresos y gasto concatenan los niveles oficiales de las metodologias 1993-2006, 2007-2014 y desde 2015 sin corregir sus quiebres; la cobertura real comienza en enero de 1997 por disponibilidad del IPC empalmado.
