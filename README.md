...
- Recaudacion total, ingresos fiscales y gasto primario se expresan en millones de pesos a precios de 2014 y se ajustan con X-13ARIMA-SEATS sobre toda la historia real disponible. El modelo evalua efectos calendario por AIC y detecta valores atipicos; cada grafico muestra la serie desestacionalizada final X-11 (`d11`) y su tendencia-ciclo (`d12`). Ingresos y gasto concatenan los niveles oficiales de las metodologias 1993-2006, 2007-2014 y desde 2015 sin corregir sus quiebres; la cobertura real comienza en enero de 1997 por disponibilidad del IPC empalmado. Los subsidios a la energia tambien se deflactan con el IPC base promedio 2014=100, pero no se desestacionalizan.
